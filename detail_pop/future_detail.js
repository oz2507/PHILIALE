...
// 	//[$modal-content]をフェードインさせる
// 	$("#modal_delete_future").fadeIn("slow");

// 	//[#modal-overlay]、または[#modal-close-future]をクリックしたら…
// 	$( "#modal-overlay" ).unbind().click( function(){

// 		//[#modal-content-future]と[#modal-overlay]をフェードアウトした後に…
// 		$( "#modal_delete_future,#modal-overlay" ).fadeOut( "slow" , function(){
...
// 	var cw = $( "#modal_delete_future" ).outerWidth();
// 	var ch = $( "#modal_delete_future" ).outerHeight();
...
// 	// #modal-content-futureのCSSにleftの値をpxleftを使って設定
// 	$("#modal_delete_future").css({"left": pxleft + "px"});

// 	// #modal-content-futureのCSSにtopの値をpxtopを使って設定
// 	$("#modal_delete_future").css({"top": pxtop + "px"});
